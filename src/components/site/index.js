  ...
  return (
    <div>
      <p>
        ...
        Na área de matrículas ele visualiza todos os cursos que possui
        e quando expiram os acessos. Em Assinaturas o aluno visualiza
        os planos ativos e altera a forma de pagamento de sua assinatura.<br/>

        Já na área de Compras é possível visualizar todas as compras feitas no EAD,
